...
local SettingsButton = {
    ...
    SelectedSprite = { Dictionary = "lspdG", Texture = "gradient_nav", Y = 0, Width = 431, Height = 38 },
}
...
local SettingsSlider = {
    ...
    LeftArrow = { Dictionary = "lspdGtu", Texture = "arrowleft", X = 235, Y = 11.5, Width = 15, Height = 15 },
    RightArrow = { Dictionary = "lspdGtu", Texture = "arrowright", X = 400, Y = 11.5, Width = 15, Height = 15 },
}
